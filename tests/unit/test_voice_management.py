...
class TestLoadVoices:
    ...
    def test_load_voices_success(self, mock_voices_json: Any, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_load_voices_file_not_found(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_load_voices_invalid_json(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_load_voices_empty_file(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_load_voices_encoding(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestDisplayVoices:
    ...
    def test_display_voices_none_input(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_display_voices_empty_dict(self) -> None:
        """Test display_voices with empty dictionary"""
        count = display_voices({})
        assert count == 0

    def test_display_voices_counts_correctly(
    ...
    def test_display_voices_without_ids(
        self, sample_voices_data: Dict[str, Any], capsys: pytest.CaptureFixture[str]
    ) -> None:
    ...
    def test_display_voices_prefix_formatting(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_display_voices_recursive_structure(self) -> None:
...
class TestGetVoiceId:
    ...
    def test_get_voice_id_first_voice(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_get_voice_id_last_voice(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_get_voice_id_invalid_choice(self, sample_voices_data: Dict[str, Any]) -> None:
        """Test with invalid choice number"""
        voice_id, _ = get_voice_id(sample_voices_data, choice=9999, current_index=0)

        assert voice_id is None

    def test_get_voice_id_zero_choice(self, sample_voices_data: Dict[str, Any]) -> None:
        """Test with zero choice"""
        voice_id, _ = get_voice_id(sample_voices_data, choice=0, current_index=0)

        assert voice_id is None

    def test_get_voice_id_negative_choice(self, sample_voices_data: Dict[str, Any]) -> None:
        """Test with negative choice"""
        voice_id, _ = get_voice_id(sample_voices_data, choice=-1, current_index=0)

        assert voice_id is None

    def test_get_voice_id_known_voice(self, sample_voices_data: Dict[str, Any]) -> None:
...
class TestCountVoiceStats:
    ...
    def test_count_voice_stats_total(self, sample_voices_data: Dict[str, Any]) -> None:
        """Test counting total voices"""
        stats = count_voice_stats(sample_voices_data)

        assert stats["total"] == 10  # Based on sample data

    def test_count_voice_stats_languages(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_count_voice_stats_countries(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_count_voice_stats_genders(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_count_voice_stats_empty(self) -> None:
    ...
    def test_count_voice_stats_single_voice(self) -> None:
...
class TestCountVoicesByLevel:
    ...
    def test_count_by_language_level(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_count_by_country_level(self, sample_voices_data: Dict[str, Any]) -> None:
...
class TestGetAllVoiceIds:
    ...
    def test_get_all_voice_ids_generator(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_get_all_voice_ids_count(self, sample_voices_data: Dict[str, Any]) -> None:
        """Test getting all voice IDs"""
        ids = list(get_all_voice_ids(sample_voices_data))

        assert len(ids) == 10

    def test_get_all_voice_ids_format(self, sample_voices_data: Dict[str, Any]) -> None:
    ...
    def test_get_all_voice_ids_empty(self) -> None:
        """Test with empty dictionary"""
        ids = list(get_all_voice_ids({}))
        assert len(ids) == 0

    def test_get_all_voice_ids_unique(self, sample_voices_data: Dict[str, Any]) -> None:
...
class TestSelectVoiceInteractive:
    ...
    def test_select_voice_direct_id(self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_select_voice_quit(self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_select_voice_full_flow(self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_select_voice_back_navigation(
        self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_select_voice_invalid_then_valid(
        self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_select_voice_restart(self, sample_voices_data: Dict[str, Any], monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestVoiceManagementEdgeCases:
    ...
    def test_mixed_structure_types(self) -> None:
    ...
    def test_empty_nested_levels(self) -> None:
